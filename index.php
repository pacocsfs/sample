...
<div class="panel-heading"><h3>La Liga Login</h3></div>
...
<p class="bg-info" id="msg"><?php echo (isset($_SESSION['msg'])) ? $_SESSION['msg'] : ''; ?></p>
 <form class="form-horizontal" role="form" id="loginForm" method="post" action="function.php?type=login">
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="email" class="form-control" name="username" placeholder="Please enter your email" required="required">
    </div>
  </div>
  <div class="form-group">
